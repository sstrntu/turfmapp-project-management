...
const handleCardRestore = (card, cardMemberships, cardLabels, tasks, attachments) => ({
...
const permanentDeleteCard = (id) => ({
  type: ActionTypes.CARD_PERMANENT_DELETE,
  payload: {
    id,
  },
});

permanentDeleteCard.success = (id) => ({
  type: ActionTypes.CARD_PERMANENT_DELETE__SUCCESS,
  payload: {
    id,
  },
});

permanentDeleteCard.failure = (id, error) => ({
  type: ActionTypes.CARD_PERMANENT_DELETE__FAILURE,
  payload: {
    id,
    error,
  },
