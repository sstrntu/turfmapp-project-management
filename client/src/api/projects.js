...
const restoreProject = (id, headers) =>
  socket.post(`/projects/${id}/restore`, {}, headers).then((body) => ({
    ...body,
    included: {
      ...body.included,
      users: body.included.users.map(transformUser),
...
const permanentDeleteProject = (id, headers) =>
  socket.delete(`/projects/${id}/permanent`, undefined, headers);
