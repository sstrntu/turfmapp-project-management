...
const restoreCard = (id, listId, headers) =>
  socket.post(`/cards/${id}/restore`, { listId }, headers).then((body) => ({
    ...body,
    item: transformCard(body.item),
  }));

const permanentDeleteCard = (id, headers) =>
  socket.delete(`/cards/${id}/permanent`, undefined, headers);
