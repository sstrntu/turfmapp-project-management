export default {
  ...
  PROJECT_RESTORE__SUCCESS: 'PROJECT_RESTORE__SUCCESS',
  PROJECT_RESTORE__FAILURE: 'PROJECT_RESTORE__FAILURE',
  PROJECT_RESTORE_HANDLE: 'PROJECT_RESTORE_HANDLE',
  PROJECT_PERMANENT_DELETE: 'PROJECT_PERMANENT_DELETE',
  PROJECT_PERMANENT_DELETE__SUCCESS: 'PROJECT_PERMANENT_DELETE__SUCCESS',
  PROJECT_PERMANENT_DELETE__FAILURE: 'PROJECT_PERMANENT_DELETE__FAILURE',
  ...
  BOARD_MILESTONE_CREATE: 'BOARD_MILESTONE_CREATE',
  BOARD_MILESTONE_CREATE__SUCCESS: 'BOARD_MILESTONE_CREATE__SUCCESS',
  BOARD_MILESTONE_CREATE__FAILURE: 'BOARD_MILESTONE_CREATE__FAILURE',
  BOARD_MILESTONE_UPDATE: 'BOARD_MILESTONE_UPDATE',
  BOARD_MILESTONE_UPDATE__SUCCESS: 'BOARD_MILESTONE_UPDATE__SUCCESS',
  BOARD_MILESTONE_UPDATE__FAILURE: 'BOARD_MILESTONE_UPDATE__FAILURE',
  BOARD_MILESTONE_DELETE: 'BOARD_MILESTONE_DELETE',
  BOARD_MILESTONE_DELETE__SUCCESS: 'BOARD_MILESTONE_DELETE__SUCCESS',
  BOARD_MILESTONE_DELETE__FAILURE: 'BOARD_MILESTONE_DELETE__FAILURE',
  ...
  CARD_RESTORE__SUCCESS: 'CARD_RESTORE__SUCCESS',
  CARD_RESTORE__FAILURE: 'CARD_RESTORE__FAILURE',
  CARD_RESTORE_HANDLE: 'CARD_RESTORE_HANDLE',
  CARD_PERMANENT_DELETE: 'CARD_PERMANENT_DELETE',
  CARD_PERMANENT_DELETE__SUCCESS: 'CARD_PERMANENT_DELETE__SUCCESS',
  CARD_PERMANENT_DELETE__FAILURE: 'CARD_PERMANENT_DELETE__FAILURE',
